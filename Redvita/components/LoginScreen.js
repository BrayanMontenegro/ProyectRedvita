...
const LoginScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={handleLogin} accessibilityLabel="Botón de inicio de sesión">
        <Text style={styles.buttonText}>Iniciar Sesión</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.createAccountButton} onPress={handleCreateAccount} accessibilityLabel="Botón para crear una cuenta">
